...
if __name__ == "__main__":
    ...
    _f1 = open("dataset/testingdata0114/dataset.csv", "w")
    _dir = "dataset/testingdata0114/dataset/"
    _dir2 = "dataset/testingdata0114/data/"
    i = 0
    for f in os.listdir(_dir):
        print(f)
        # for ff in os.listdir((_dir + f)):
        #     print(ff)
            # for fff in os.listdir((_dir + f + "/" + ff)):
            #     print(fff)
        _image = cv2.imread(_dir + f, cv2.IMREAD_COLOR)
        _image = cv2.resize(_image, (720, 480))
        ...
        i = i + 1
        cv2.imwrite(_dir2 + img_name, _image)
